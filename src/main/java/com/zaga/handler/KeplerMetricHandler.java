...
private KeplerMetric convertDocumentToMetricDTO(Document document) {
    ...
    KafkaMetrics keplerMetric = new KafkaMetrics();

    keplerMetric.setServiceName(document.getString("serviceName")); 
    keplerMetric.setKafkaCallCount(document.getLong("kafkaCallCount"));
    keplerMetric.setKafkaPeakLatency(document.getLong("memoryUsage"));
